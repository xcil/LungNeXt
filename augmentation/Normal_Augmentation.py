...
def augment_raw_audio(sample, sample_rate):
    """
...
def augment_raw(sample, sample_rate, augmentation_method):
    ...
    if augmentation_method == "nlpaug":
    ...
    elif augmentation_method == "audiomentations":
        """ 2) audiomentations """
        import audiomentations
        from audiomentations import AddGaussianSNR, TimeStretch, PitchShift, Shift
    ...
    elif augmentation_method == "librosa":
        """ 3) librosa """
        import librosa
        ...
        raise ValueError('Invalid augmentation_method: {}'.format(augmentation_method))
...
class SpecAugment(torch.nn.Module):
    ...
    def __init__(self, args):
        ...
        elif self.policy == 'SPRS':
            self.W, self.F, self.m_F, self.T, self.p, self.m_T = 40, 48, 1, 80, 1.0, 1
